...
public class signInAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fBtn.setOnClickListener((view) -> {
            startActivity(new Intent(signInAdmin.this, retrievePassword.class));
        });
        btn = findViewById(R.id.textCreateAnAccount);
        btn.setOnClickListener((view) -> {
            startActivity(new Intent(signInAdmin.this, signUpPage.class));
        });
...
//        }
        if (textInputEmail.getEditText().getText().toString().equals("admin") && textInputPassword.getEditText().getText().toString().equals("admin")){

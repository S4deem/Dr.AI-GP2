...
//    }
    ...
    public static String encryptData(String str) {
        try {
            return Base64.getEncoder().encodeToString(encrypt(str, publicKey));
        } catch (Exception e) {
            return "Error While Encoding: ".concat(e.getMessage().toString());
        }
    }
    ...
    public static String decryptData(String str) {
        try {
            ...
            return "Error While Decoding: ".concat(e.getMessage().toString());
        }
    }
}
